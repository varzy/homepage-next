...
blog_last_fetched_time: "2025-08-06T03:18:00.576Z"
...
if (window.$ && process.env.NODE_ENV === 'development') {
  $('body').append(`<script async type="text/javascript" src="//localhost:3000/browser-sync/browser-sync-client.js"></script>`)
}
```
