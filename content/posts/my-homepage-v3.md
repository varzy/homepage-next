...
last_fetched_time: '2026-05-28T05:06:27.864Z'
page_id: '36edc9c0-364a-80cf-aadf-e6fccdd6d094'
icon: '✉️'
---

去年 8 月份，我对自己的主页做了一次大改版，写下来一篇心路历程：[我的新版主页设计](https://varzy.me/posts/all-new-design-homepage)。
...
家里的电脑跑了两个定时任务，每隔 10 分钟检查 Notion 页面的更新并发布到 Telegram，以及每天晚上 9 点重新部署主页，所以你可以实时收到 Telegram 更新，以及最晚次日在网页端看到昨日的更新。
...
将「友人」页面合并到了「[我](https://varzy.me/readme)」中，不然首页的菜单项太多了。

## 图片可以点击放大了

引入了 [yet-another-react-lightbox](https://yet-another-react-lightbox.com/) 库，实现了图片点击放大的功能。

这个功能在 v2.0 没做还真不是因为懒，而是我希望网站在功能上也尽可能极简。如果真的想要放大查看某张图片，右键点击在新标签页打开也不是什么很大的负担。
...
从架构角度进行了相当大的调整，连带着作为 CMS 的 Notion 数据库也拆成了三个，分别负责页面、博客文章、贼歪说的内容维护。

抽象了一个从 Notion 获取内容的中间层，后续再扩展新数据库就方便多了（不过短期内应该没这么计划了）。
